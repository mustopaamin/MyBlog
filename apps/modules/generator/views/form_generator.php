...
?>
  ...
  <div class="box box-info">
	...
	<?php echo form_open(site_url('generator/fnGenerate'), array('id'=>'fgenerate','class' => 'form-horizontal', 'role' => 'form'));?>
	<div class="box-body">
		...
		<br/><br/>
		<div class="form-group">
			<div class="col-md-2"><label style="padding-top:7px;">View dan Form</label></div>
			<div class="col-md-6">
			<?php
				$df = array(1=>'Gabung',2=>'Pisah');
				echo form_dropdown('df',$df,false,"id='df' class='form-control chosen'");
			?>	
			</div>
		</div>
		<br>
...
$(function(){
	...
	$("#tabel").change(function(){
			$.post("<?php echo site_url('generator/field_tabel')?>",{tabel : $(this).val(),<?php echo $this->security->get_csrf_token_name(); ?>: '<?php echo $this->security->get_csrf_hash(); ?>'}, function(msg){
					if(msg)
					{
